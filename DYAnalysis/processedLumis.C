#define processedLumis_cxx
#include "processedLumis.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <set>
...
// METHOD1:
   ...
   fChain->SetBranchStatus("lumiBlock",1);  // activate branchname
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      pair<int,int> p(runNum,lumiBlock);
