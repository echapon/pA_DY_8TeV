...
// Thu Oct 31 21:04:13 2019 by ROOT version 6.06/01
// from TTree DYTree/DYTree
// found on file: /eos/cms/store/group/phys_heavyions/dileptons/echapon/pA_8p16TeV/DYtuples/PASingleMuon/crab_PASingleMuon_DYtuple_PAL3Mu12_1stpart_20170518/170517_220343/0000/ntuple_skim_all.root
//////////////////////////////////////////////////////////

#ifndef processedLumis_h
#define processedLumis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        PVz;
   Int_t           HLT_ntrig;
   Int_t           HLT_trigType[38];   //[HLT_ntrig]
   Int_t           HLT_trigFired[38];   //[HLT_ntrig]
   vector<string>  *HLT_trigName;
   vector<int>     *HLT_trigPS;
   Double_t        HLT_trigPt[38];   //[HLT_ntrig]
   Double_t        HLT_trigEta[38];   //[HLT_ntrig]
   Double_t        HLT_trigPhi[38];   //[HLT_ntrig]
   Int_t           Njets;
   Double_t        Jet_pT[40];   //[Njets]
   Double_t        Jet_eta[40];   //[Njets]
   Double_t        Jet_phi[40];   //[Njets]
   Double_t        Jet_Charge[40];   //[Njets]
   Int_t           Jet_Flavor[40];   //[Njets]
   Double_t        Jet_bTag[40];   //[Njets]
   Double_t        Jet_CHfrac[40];   //[Njets]
   Double_t        Jet_NHfrac[40];   //[Njets]
   Double_t        Jet_NHEMfrac[40];   //[Njets]
   Double_t        Jet_CHEMfrac[40];   //[Njets]
   Int_t           Jet_CHmulti[40];   //[Njets]
   Int_t           Jet_NHmulti[40];   //[Njets]
   Int_t           Nelectrons;
   ...
   Char_t          Electron_hasConversion[7];   //[Nelectrons]
   ...
   Int_t           Electron_passVetoID[7];   //[Nelectrons]
   Int_t           Electron_passLooseID[7];   //[Nelectrons]
   Int_t           Electron_passMediumID[7];   //[Nelectrons]
   Int_t           Electron_passTightID[7];   //[Nelectrons]
   ...
   Int_t           Muon_muonType[14];   //[nMuon]
   Int_t           isPFmuon[14];   //[nMuon]
   Int_t           isGLBmuon[14];   //[nMuon]
   Int_t           isTRKmuon[14];   //[nMuon]
   Int_t           isSTAmuon[14];   //[nMuon]
   Int_t           isLooseMuon[14];   //[nMuon]
   Int_t           isMediumMuon[14];   //[nMuon]
   Int_t           isTightMuon[14];   //[nMuon]
   Int_t           isSoftMuon[14];   //[nMuon]
   Int_t           isHighPtMuon[14];   //[nMuon]
   Int_t           Muon_nTrig[14];   //[nMuon]
   Int_t           Muon_triggerObjectType[14];   //[nMuon]
   Int_t           Muon_filterName[14];   //[nMuon]
   Double_t        Muon_phi[14];   //[nMuon]
   Double_t        Muon_eta[14];   //[nMuon]
   Double_t        Muon_pT[14];   //[nMuon]
   Double_t        Muon_cktpT[14];   //[nMuon]
   Double_t        Muon_cktPx[14];   //[nMuon]
   Double_t        Muon_cktPy[14];   //[nMuon]
   Double_t        Muon_cktPz[14];   //[nMuon]
   Double_t        Muon_cktpTError[14];   //[nMuon]
   Double_t        Muon_Px[14];   //[nMuon]
   Double_t        Muon_Py[14];   //[nMuon]
   Double_t        Muon_Pz[14];   //[nMuon]
   Double_t        Muon_trkiso[14];   //[nMuon]
   Double_t        Muon_hcaliso[14];   //[nMuon]
   Double_t        Muon_ecaliso[14];   //[nMuon]
   Double_t        Muon_trkisoR05[14];   //[nMuon]
   Double_t        Muon_hcalisoR05[14];   //[nMuon]
   Double_t        Muon_ecalisoR05[14];   //[nMuon]
   Double_t        Muon_Best_pT[14];   //[nMuon]
   Double_t        Muon_Best_pTError[14];   //[nMuon]
   Double_t        Muon_Best_Px[14];   //[nMuon]
   Double_t        Muon_Best_Py[14];   //[nMuon]
   Double_t        Muon_Best_Pz[14];   //[nMuon]
   Double_t        Muon_Best_eta[14];   //[nMuon]
   Double_t        Muon_Best_phi[14];   //[nMuon]
   Double_t        Muon_Inner_pT[14];   //[nMuon]
   Double_t        Muon_Inner_pTError[14];   //[nMuon]
   Double_t        Muon_Inner_Px[14];   //[nMuon]
   Double_t        Muon_Inner_Py[14];   //[nMuon]
   Double_t        Muon_Inner_Pz[14];   //[nMuon]
   Double_t        Muon_Inner_eta[14];   //[nMuon]
   Double_t        Muon_Inner_phi[14];   //[nMuon]
   Double_t        Muon_Outer_pT[14];   //[nMuon]
   Double_t        Muon_Outer_pTError[14];   //[nMuon]
   Double_t        Muon_Outer_Px[14];   //[nMuon]
   Double_t        Muon_Outer_Py[14];   //[nMuon]
   Double_t        Muon_Outer_Pz[14];   //[nMuon]
   Double_t        Muon_Outer_eta[14];   //[nMuon]
   Double_t        Muon_Outer_phi[14];   //[nMuon]
   Double_t        Muon_GLB_pT[14];   //[nMuon]
   Double_t        Muon_GLB_pTError[14];   //[nMuon]
   Double_t        Muon_GLB_Px[14];   //[nMuon]
   Double_t        Muon_GLB_Py[14];   //[nMuon]
   Double_t        Muon_GLB_Pz[14];   //[nMuon]
   Double_t        Muon_GLB_eta[14];   //[nMuon]
   Double_t        Muon_GLB_phi[14];   //[nMuon]
   Double_t        Muon_TuneP_pT[14];   //[nMuon]
   Double_t        Muon_TuneP_pTError[14];   //[nMuon]
   Double_t        Muon_TuneP_Px[14];   //[nMuon]
   Double_t        Muon_TuneP_Py[14];   //[nMuon]
   Double_t        Muon_TuneP_Pz[14];   //[nMuon]
   Double_t        Muon_TuneP_eta[14];   //[nMuon]
   Double_t        Muon_TuneP_phi[14];   //[nMuon]
   Double_t        Muon_PfChargedHadronIsoR05[14];   //[nMuon]
   Double_t        Muon_PfNeutralHadronIsoR05[14];   //[nMuon]
   Double_t        Muon_PfGammaIsoR05[14];   //[nMuon]
   Double_t        Muon_PfChargedHadronIsoR04[14];   //[nMuon]
   Double_t        Muon_PfNeutralHadronIsoR04[14];   //[nMuon]
   Double_t        Muon_PfGammaIsoR04[14];   //[nMuon]
   Double_t        Muon_PFSumPUIsoR04[14];   //[nMuon]
   Double_t        Muon_PfChargedHadronIsoR03[14];   //[nMuon]
   Double_t        Muon_PfNeutralHadronIsoR03[14];   //[nMuon]
   Double_t        Muon_PfGammaIsoR03[14];   //[nMuon]
   Double_t        Muon_PFSumPUIsoR03[14];   //[nMuon]
   Int_t           Muon_charge[14];   //[nMuon]
   Int_t           Muon_nChambers[14];   //[nMuon]
   Int_t           Muon_nMatches[14];   //[nMuon]
   Int_t           Muon_stationMask[14];   //[nMuon]
   Int_t           Muon_nSegments[14];   //[nMuon]
   Double_t        Muon_chi2dof[14];   //[nMuon]
   Int_t           Muon_nhits[14];   //[nMuon]
   Int_t           Muon_trackerHits[14];   //[nMuon]
   Int_t           Muon_trackerLayers[14];   //[nMuon]
   Int_t           Muon_pixelHits[14];   //[nMuon]
   Int_t           Muon_muonHits[14];   //[nMuon]
   Double_t        Muon_qoverp[14];   //[nMuon]
   Double_t        Muon_theta[14];   //[nMuon]
   Double_t        Muon_lambda[14];   //[nMuon]
   Double_t        Muon_dxy[14];   //[nMuon]
   Double_t        Muon_d0[14];   //[nMuon]
   Double_t        Muon_dsz[14];   //[nMuon]
   Double_t        Muon_dz[14];   //[nMuon]
   Double_t        Muon_dxyBS[14];   //[nMuon]
   Double_t        Muon_dszBS[14];   //[nMuon]
   Double_t        Muon_dzBS[14];   //[nMuon]
   Double_t        Muon_dxyVTX[14];   //[nMuon]
   Double_t        Muon_dszVTX[14];   //[nMuon]
   Double_t        Muon_dzVTX[14];   //[nMuon]
   Double_t        Muon_dxycktVTX[14];   //[nMuon]
   Double_t        Muon_dszcktVTX[14];   //[nMuon]
   Double_t        Muon_dzcktVTX[14];   //[nMuon]
   Double_t        Muon_vx[14];   //[nMuon]
   Double_t        Muon_vy[14];   //[nMuon]
   Double_t        Muon_vz[14];   //[nMuon]
   ...
   Int_t           GENnPair;
   Double_t        GENLepton_phi[1];   //[GENnPair]
   Double_t        GENLepton_eta[1];   //[GENnPair]
   Double_t        GENLepton_pT[1];   //[GENnPair]
   Double_t        GENLepton_Px[1];   //[GENnPair]
   Double_t        GENLepton_Py[1];   //[GENnPair]
   Double_t        GENLepton_Pz[1];   //[GENnPair]
   Double_t        GENLepton_mother[1];   //[GENnPair]
   Int_t           GENLepton_charge[1];   //[GENnPair]
   Int_t           GENLepton_status[1];   //[GENnPair]
   Int_t           GENLepton_ID[1];   //[GENnPair]
   Int_t           GENLepton_isPrompt[1];   //[GENnPair]
   Int_t           GENLepton_isPromptFinalState[1];   //[GENnPair]
   Int_t           GENLepton_isTauDecayProduct[1];   //[GENnPair]
   Int_t           GENLepton_isPromptTauDecayProduct[1];   //[GENnPair]
   Int_t           GENLepton_isDirectPromptTauDecayProductFinalState[1];   //[GENnPair]
   Int_t           GENLepton_isHardProcess[1];   //[GENnPair]
   Int_t           GENLepton_isLastCopy[1];   //[GENnPair]
   Int_t           GENLepton_isLastCopyBeforeFSR[1];   //[GENnPair]
   Int_t           GENLepton_isPromptDecayed[1];   //[GENnPair]
   Int_t           GENLepton_isDecayedLeptonHadron[1];   //[GENnPair]
   Int_t           GENLepton_fromHardProcessBeforeFSR[1];   //[GENnPair]
   Int_t           GENLepton_fromHardProcessDecayed[1];   //[GENnPair]
   Int_t           GENLepton_fromHardProcessFinalState[1];   //[GENnPair]
   Int_t           GENLepton_isMostlyLikePythia6Status3[1];   //[GENnPair]
   Double_t        GENEvt_weight;
   Int_t           nGenOthers;
   Double_t        GenOthers_phi[1];   //[nGenOthers]
   Double_t        GenOthers_eta[1];   //[nGenOthers]
   Double_t        GenOthers_pT[1];   //[nGenOthers]
   Double_t        GenOthers_Px[1];   //[nGenOthers]
   Double_t        GenOthers_Py[1];   //[nGenOthers]
   Double_t        GenOthers_Pz[1];   //[nGenOthers]
   Double_t        GenOthers_mother[1];   //[nGenOthers]
   Int_t           GenOthers_charge[1];   //[nGenOthers]
   Int_t           GenOthers_status[1];   //[nGenOthers]
   Int_t           GenOthers_ID[1];   //[nGenOthers]
   Int_t           GenOthers_isPrompt[1];   //[nGenOthers]
   Int_t           GenOthers_isPromptFinalState[1];   //[nGenOthers]
   Int_t           GenOthers_isTauDecayProduct[1];   //[nGenOthers]
   Int_t           GenOthers_isPromptTauDecayProduct[1];   //[nGenOthers]
   Int_t           GenOthers_isDirectPromptTauDecayProductFinalState[1];   //[nGenOthers]
   Int_t           GenOthers_isHardProcess[1];   //[nGenOthers]
   Int_t           GenOthers_isLastCopy[1];   //[nGenOthers]
   Int_t           GenOthers_isLastCopyBeforeFSR[1];   //[nGenOthers]
   Int_t           GenOthers_isPromptDecayed[1];   //[nGenOthers]
   Int_t           GenOthers_isDecayedLeptonHadron[1];   //[nGenOthers]
   Int_t           GenOthers_fromHardProcessBeforeFSR[1];   //[nGenOthers]
   Int_t           GenOthers_fromHardProcessDecayed[1];   //[nGenOthers]
   Int_t           GenOthers_fromHardProcessFinalState[1];   //[nGenOthers]
   Int_t           GenOthers_isMostlyLikePythia6Status3[1];   //[nGenOthers]
   Int_t           nPhotons;
   Int_t           Photon_hasPixelSeed[8];   //[nPhotons]
   Double_t        Photon_pT[8];   //[nPhotons]
   Double_t        Photon_eta[8];   //[nPhotons]
   Double_t        Photon_phi[8];   //[nPhotons]
   Double_t        Photon_etaSC[8];   //[nPhotons]
   Double_t        Photon_phiSC[8];   //[nPhotons]
   Double_t        Photon_HoverE[8];   //[nPhotons]
   Double_t        Photon_Full5x5_SigmaIEtaIEta[8];   //[nPhotons]
   Double_t        Photon_ChIso[8];   //[nPhotons]
   Double_t        Photon_NhIso[8];   //[nPhotons]
   Double_t        Photon_PhIso[8];   //[nPhotons]
   Double_t        Photon_ChIsoWithEA[8];   //[nPhotons]
   Double_t        Photon_NhIsoWithEA[8];   //[nPhotons]
   Double_t        Photon_PhIsoWithEA[8];   //[nPhotons]
   Int_t           nPileUp;
   ...
   processedLumis(TTree *tree=0);
   virtual ~processedLumis();
...
#ifdef processedLumis_cxx
processedLumis::processedLumis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_heavyions/dileptons/echapon/pA_8p16TeV/DYtuples/PASingleMuon/crab_PASingleMuon_DYtuple_PAL3Mu12_1stpart_20170518/170517_220343/0000/ntuple_skim_all.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_heavyions/dileptons/echapon/pA_8p16TeV/DYtuples/PASingleMuon/crab_PASingleMuon_DYtuple_PAL3Mu12_1stpart_20170518/170517_220343/0000/ntuple_skim_all.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_heavyions/dileptons/echapon/pA_8p16TeV/DYtuples/PASingleMuon/crab_PASingleMuon_DYtuple_PAL3Mu12_1stpart_20170518/170517_220343/0000/ntuple_skim_all.root:/recoTree");
...
processedLumis::~processedLumis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t processedLumis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t processedLumis::LoadTree(Long64_t entry)
{
...
void processedLumis::Init(TTree *tree)
{
...
void processedLumis::Show(Long64_t entry)
{
...
Int_t processedLumis::Cut(Long64_t entry)
{
...
#endif // #ifdef processedLumis_cxx
