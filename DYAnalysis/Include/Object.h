...
// -- 2016.10.24 (v01): Add LHEParticle & Include NtupleHandle_v01.h
// -- 2016.11.04 (v02): Correct dR matching in the trgger & include v02 headers
///////////////////////////////////////////////////////////////
...
public:
	...
	{
		Px 		= ntuple->LHELepton_Px[index];
		Py 		= ntuple->LHELepton_Py[index];
		Pz 		= ntuple->LHELepton_Pz[index];
		E 		= ntuple->LHELepton_E[index];
		ID 		= ntuple->LHELepton_ID[index];
		Status 	= ntuple->LHELepton_status[index];
