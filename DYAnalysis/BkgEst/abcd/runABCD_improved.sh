...
# run ABCD method
root -l -b -q runABCD_improved.C'("PAL1DoubleMu0","DataMinusMC")'
root -l -b -q runABCD_improved.C'("PAL1DoubleMu0","QCD")'
root -l -b -q runABCD_improved.C'("PAL3Mu12","DataMinusMC")'
root -l -b -q runABCD_improved.C'("PAL3Mu12","QCD")'
