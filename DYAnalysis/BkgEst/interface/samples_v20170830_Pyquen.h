...
namespace DYana_v20170830_Pyquen {
   ...
   int Nevts(SampleTag s) {
      switch (s) {
         ...
         case DYMuMu30:    return 992450; break;
   ...
   const char* PathTuple(SampleTag s) {
      switch (s) {
         ...
         case DYMuMu30:  return "/eos/cms/store/group/phys_heavyions/dileptons/echapon/pA_8p16TeV/DYtuples/DYtoMuMu_M-30_pPb-Bst_8p16TeV-Pyquen/crab_DYtoMuMu_M-30_pPb_Pyquen_20170919/170919_163037/0000/ntuple_skim*root"; break;
