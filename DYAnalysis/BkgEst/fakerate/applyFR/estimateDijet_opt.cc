	...
	for (int optval=1;optval<8;optval++) {
      ...
      cmsTextSize = 0.75;
		...
		for (int i=0; i<ALL; i++) {
			...
			std::cout << "Entries : " << dijet_template[i]->GetEntries() << std::endl;
			...
			cout<<"TW OS before = "<<dijet_template[TW]->Integral()<<endl;
			cout<<"TW SS before = "<<dijetSS_template[TW]->Integral()<<endl;
			...
			canv->Print(Form("print/dijet_template_%s_beforeremove_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_template_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_template_%s_removedDY_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_template_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_template_%s_removedTT_%s.pdf",outtitle.Data(),rmk.Data()));

			dijet_template[Data1]->Add(dijet_template[TW],-1.0);
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_template_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_template_%s_removedTW_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_template_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_template_%s_removedWWs_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_template_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_template_%s_DYs_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_template_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_template_%s_TTs_%s.pdf",outtitle.Data(),rmk.Data()));


			dijet_template[TW]->Draw("HIST");
			CMS_lumi(canv,13,11);
			canv->Update();
			canv->RedrawAxis();
			canv->GetFrame()->Draw();
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_template_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_template_%s_TWs_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_template_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_template_%s_WWs_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			canv->Print(Form("print/dijet_ratio_%s_beforeremove_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_ratio_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_ratio_%s_removedDY_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_ratio_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_ratio_%s_removedTT_%s.pdf",outtitle.Data(),rmk.Data()));

			dijet_ratio[Data1]->Add(dijet_ratio[TW],-1.0);
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_ratio_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_ratio_%s_removedTW_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_ratio_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_ratio_%s_removedWWs_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_ratio_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_ratio_%s_DYs_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_ratio_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_ratio_%s_TTs_%s.pdf",outtitle.Data(),rmk.Data()));

			dijet_ratio[TW]->Draw("HIST");
			CMS_lumi(canv,13,11);
			canv->Update();
			canv->RedrawAxis();
			canv->GetFrame()->Draw();
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_ratio_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_ratio_%s_TWs_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_ratio_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_ratio_%s_WWs_%s.pdf",outtitle.Data(),rmk.Data()));
			...
			if (optval==1) canv->SetLogx();
			//canv->Print("print/dijet_template_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijet_template_%s_%s.pdf",outtitle.Data(),rmk.Data()));
			dijetSS_template[Data1]->Draw("EPSAME");
			legg->Draw("SAME");
			//canv->Print("print/dijetBoth_template_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijetBoth_template_%s_%s.pdf",outtitle.Data(),rmk.Data()));
			canv->Clear();
			...
			canv->Print(Form("print/dijetSS_template_%s_%s.pdf",outtitle.Data(),rmk.Data()));
			canv->Clear();
			...
			canv->Print(Form("print/dijet_ratio_%s_%s.pdf",outtitle.Data(),rmk.Data()));
			dijetSS_ratio[Data1]->Draw("EPSAME");
			legg->Draw("SAME");
			//canv->Print("print/dijetBoth_ratio_rap1560_noFRweight.pdf");
			canv->Print(Form("print/dijetBoth_ratio_%s_%s.pdf",outtitle.Data(),rmk.Data()));
			canv->Clear();
			...
			canv->Print(Form("print/dijetSS_ratio_%s_%s.pdf",outtitle.Data(),rmk.Data()));
			canv->Clear();
			...
			TH1D* dijet;
			if (FRopt==1) dijet = (TH1D*)dijet_template[Data1]->Clone();
			else dijet = (TH1D*)dijet_ratio[Data1]->Clone();
			...
			else if (optval==6) {dijet_total = new TH1D("dijet_total","",ptbinnum_meas_1560,ptbin_meas_1560);dijet_systematic = new TH1D("dijet_systematic","",ptbinnum_meas_1560,ptbin_meas_1560);dijet_stat = new TH1D("dijet_stat","",ptbinnum_meas_1560,ptbin_meas_1560);}
			else if (optval==7) {dijet_total = new TH1D("dijet_total","",phistarnum_1560,phistarbin_1560);dijet_systematic = new TH1D("dijet_systematic","",phistarnum_1560,phistarbin_1560);dijet_stat = new TH1D("dijet_stat","",phistarnum_1560,phistarbin_1560);}
			...
			TFile* gg = new TFile(Form("result/dijet_%s_%s_FRopt%d.root",outtitle.Data(),rmk.Data(),FRopt),"RECREATE"); 
			dijet->Write();
			...
			canv->Print(Form("print/dijet_uncertainty_%s_%s.pdf",outtitle.Data(),rmk.Data()));
			//TFile* gg = new TFile("result/dijet_rap1560_noFRweight.root","RECREATE");
