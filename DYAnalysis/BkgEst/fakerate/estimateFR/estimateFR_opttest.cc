...
void estimateFR_opttest(TString rmk,TString ntrmk) {
...
*/
  ...
  for (int i=WmMu; i<=WmTau; i++) {
   ...
   hratio_xsecvsfit->GetXaxis()->SetTitleOffset(1.0);
	...
	chs->SaveAs(Form("print_opttest/Comp_Xsec_vs_Fit_%s_%s.pdf",Name(tag),rmk.Data()));	
...
//	 chs1->SaveAs("print/Comp_Data_vs_Xsec_stacked_opt16_QCDopt2_histZVETO_SMUwJET_MuPtlt15_QCDin0p875Data.pdf");
	 chs1->SaveAs(Form("print_opttest/Comp_Data_vs_Xsec_stacked_%s.pdf",rmk.Data()));
...
//	 chs1->SaveAs("print/Comp_Data_vs_Fit_stacked_opt16_QCDopt2_histZVETO_SMUwJET_MuPtlt15_QCDin0p875Data.pdf");
	 chs1->SaveAs(Form("print_opttest/Comp_Data_vs_Fit_stacked_%s.pdf",rmk.Data()));
...
*/
    ...
    canv->Print(Form("print_opttest/FR_Barrel_%s.pdf",rmk.Data()));
    ...
    canv->Print(Form("print_opttest/FR_Endcap_%s.pdf",rmk.Data()));
	...
	TFile* g = new TFile(Form("result_opttest/fakerate_%s.root",rmk.Data()),"RECREATE");
