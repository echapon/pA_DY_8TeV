...
void estimateFR_opttest_v2(TString rmk,TString ntrmk, TString muonIDopt) {
...
/*
	TFile* fin_fitNch_barrel = new TFile(Form("histograms_opttest/histFRFit_barrel_%s%s_QCDin0p875Data.root",ntrmk.Data(),muonIDopt.Data()),"read");
	TFile* fin_fitNch_endcap = new TFile(Form("histograms_opttest/histFRFit_endcap_%s%s_QCDin0p875Data.root",ntrmk.Data(),muonIDopt.Data()),"read");
*/

	TFile* fin_fitNch_barrel = new TFile(Form("histograms_20180814/histFRFit_barrel_%s%s_QCDin0p875Data.root",ntrmk.Data(),muonIDopt.Data()),"read");
	TFile* fin_fitNch_endcap = new TFile(Form("histograms_20180814/histFRFit_endcap_%s%s_QCDin0p875Data.root",ntrmk.Data(),muonIDopt.Data()),"read");
...
*/
	 ...
	 for (int i=0; i<=QCD; i++) {
		...
		//###file[i] = new TFile(Form("histograms_test/histFR_%s_%s%s.root",rmk.Data(),Name(tag),muonIDopt.Data()));
		file[i] = new TFile(Form("histograms_20180814/histFR_%s_%s%s.root",rmk.Data(),Name(tag),muonIDopt.Data()));
		//file[i] = new TFile(Form("histograms/%s%s.root",ntrmk.Data(),Name(tag)));
	 }
...
//######	chs->SaveAs(Form("print_opttest/Comp_Xsec_vs_Fit_%s_%s%s.pdf",ntrmk.Data(),Name(tag),muonIDopt.Data()));	
	chs->SaveAs(Form("print_20180814/Comp_Xsec_vs_Fit_%s_%s%s.pdf",ntrmk.Data(),Name(tag),muonIDopt.Data()));
}
...
//######	 chs1->SaveAs(Form("print_opttest/Comp_Data_vs_Xsec_stacked_%s%s.pdf",ntrmk.Data(),muonIDopt.Data()));
	chs1->SaveAs(Form("print_20180814/Comp_Data_vs_Xsec_stacked_%s%s.pdf",ntrmk.Data(),muonIDopt.Data()));
...
//######	 chs1->SaveAs(Form("print_opttest/Comp_Data_vs_Fit_stacked_%s%s.pdf",ntrmk.Data(),muonIDopt.Data()));
	 chs1->SaveAs(Form("print_20180814/Comp_Data_vs_Fit_stacked_%s%s.pdf",ntrmk.Data(),muonIDopt.Data()));
...
*/
    ...
    //#####canv->Print(Form("print_opttest/FR_Barrel_%s%s.pdf",ntrmk.Data(),muonIDopt.Data()));
	 canv->Print(Form("print_20180814/FR_Barrel_%s%s.pdf",ntrmk.Data(),muonIDopt.Data()));
    ...
    //##########canv->Print(Form("print_opttest/FR_Endcap_%s%s.pdf",ntrmk.Data(),muonIDopt.Data()));
	 canv->Print(Form("print_20180814/FR_Endcap_%s%s.pdf",ntrmk.Data(),muonIDopt.Data()));
    ...
    //TFile* g = new TFile("result/fakerate_opt16_QCDopt2_histZVETO_SMUwJET_MuPtlt15_QCDin0p875Data.root","RECREATE");
	 //######TFile* g = new TFile(Form("result_opttest/fakerate_%s%s.root",ntrmk.Data(),muonIDopt.Data()),"RECREATE");
	 TFile* g = new TFile(Form("result_20180814/fakerate_%s%s.root",ntrmk.Data(),muonIDopt.Data()),"RECREATE");
