...
dir=/afs/cern.ch/user/e/echapon/workspace/private/2016_pPb/DY/tree_ana/PADrellYan8TeV/DYAnalysis/BkgEst/fakerate_Emilien
...
echo root -l -b -q fillHistosForFR.C+'('${1}')'
root -l -b -q fillHistosForFR.C+'('${1}')'
