...
# with command line options: miniaodMC2 --mc -s PAT --datatier MINIAOD --eventcontent MINIAODSIM --conditions 80X_mcRun2_pA_v4 --runUnscheduled --era Run2_2016_pA --filein /store/hidata/PARun2016B/PADoubleMuon/AOD/PromptReco-v1/000/284/958/00000/BCB00EE5-5BAB-E611-B3DB-02163E014319.root --fileout miniaodtest.root --no_exec
...
process.source = cms.Source("PoolSource",
      fileNames = cms.untracked.vstring('/store/user/echapon/PrivateMC_pA_8p16TeV/Pyquen_DYtoLL_M_10to50_embd_pPb/step3_20170509/170509_141718/0000/step3_25ns_RAW2DIGI_L1Reco_RECO_10.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('miniaodMC2 nevts:1'),
...
# extend for HI
process.MINIAODSIMoutput.outputCommands.extend(cms.untracked.vstring('keep recoCentrality*_*_*_*',
